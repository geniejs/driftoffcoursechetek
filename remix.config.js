			...
			replace({
				...
				values: {
					...
					'function checkTypeSupport':
						'function checkTypeSupport(type){return false;} function a',
					'querystring.escape': 'encodeURIComponent',
					'global.ReadableStream': 'ReadableStream',
					'global.fetch': 'fetch',
					'process.nextTick': 'nextTick',
					'request.host':
						'request.protocol = parsedUrl && parsedUrl.protocol ? parsedUrl.protocol : "https:"; request.host',
					't:void 0': 't:""',
					//sendgrid
					'options.baseURL = options.baseUrl':
						'options.adapter = fetchAdapter; options.baseURL = options.baseUrl',
				},
			}),
			alias({
