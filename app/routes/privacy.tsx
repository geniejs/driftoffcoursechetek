...
export default function Privacy() {
	...
	return (
		<div className="privacy card flex min-h-screen flex-col gap-4 bg-secondary text-secondary-content">
			<div className="card-body">
				...
				<ul>
					...
					<li>
						<p>
							...
							in this Agreement) refers to Drift Off Course.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Drift Off Course, accessible
							from{' '}
							<a
								href="driftoffcoursechetek.com"
								rel="external nofollow noopener"
								target="_blank"
							>
								driftoffcoursechetek.com
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>By email: support@driftoffcoursechetek.com</li>
				</ul>
			</div>
		</div>
	);
